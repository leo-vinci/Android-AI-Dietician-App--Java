...
package com.example.diet.androiddieticianapp.AIFood;
...
import com.example.diet.androiddieticianapp.AddFoodActivity;
import com.example.diet.androiddieticianapp.R;
import com.example.diet.androiddieticianapp.AIFood.customview.OverlayView;
import com.example.diet.androiddieticianapp.AIFood.env.BorderedText;
import com.example.diet.androiddieticianapp.AIFood.env.ImageUtils;
import com.example.diet.androiddieticianapp.AIFood.env.Logger;
import com.example.diet.androiddieticianapp.AIFood.tflite.Classifier;
import com.example.diet.androiddieticianapp.AIFood.tflite.TFLiteObjectDetectionAPIModel;
import com.example.diet.androiddieticianapp.AIFood.tracking.MultiBoxTracker;
                            ...
                            public void onClick(View v) {
                                for (final Classifier.Recognition result : results) {
                                    ...
                                    if (location != null && result.getConfidence() >= finalMinimumConfidence) {
                                        ...
                                        mappedRecognitions.add(result);
                                        try {
                                            AddFoodActivity.getInstance().addFood(String.format(result.getTitle()) , croppedBitmap);
                                        } catch (IOException e) {
                                            e.printStackTrace();
                                        }
                                    }
